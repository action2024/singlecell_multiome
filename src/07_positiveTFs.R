...
#archRdirpath<-"/cluster/home/liuji/T1D/multiome/analysis/SEM01_S4D5/peakcalling/Clusters_Combined"
...
# in case the loop breaks, use trycatch to avoid clusters that fail
for(i in 1:length(allclusters)){
  ...
  #assay(getMatrixFromProject(projMulti_filtered_subset, useMatrix = "MotifMatrix"))
